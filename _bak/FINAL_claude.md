>
> THIS VERSION is the final (fully functional) version before adding Cloudflare Tunnel.
> The modular playbooks were created from this file + docs/CLOUDFLARE-TUNNEL.md
> Only refer to this file if the playbooks are no longer working.
>
...
1. **Obscured URL paths**: Services use non-standard paths to avoid bot scanners:
...
3. **VPS-2 monitoring services - networking and security**:
...
4. **Caddy reverse proxy for Grafana - handle vs handle_path**:
